...
data['headline_text'] = data['headline_text'].apply(lambda x: re.sub(r'\d+','',x))
...
# cleaned data
clean_headlines = [clean(x).split() for x in headlines]
...
print('Coherence score with 5 topics is: ', coherence_lda)
...
def compute_coherence_values(dictionary, corpus, texts, limit, start=2, step=3):
    ...
    for num_topics in range(start, limit , step):
        model = LdaModel(doc_term_matrix, num_topics = num_topics , random_state =2 ,id2word = dictionary , iterations = 10)
